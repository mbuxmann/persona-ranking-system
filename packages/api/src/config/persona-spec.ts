 ...
 * This persona specification is used by the AI ranking agent to score leads
 *
 * Bundled as a TypeScript constant to ensure it's always available in production
 * (avoids file system dependencies that break in serverless/containerized environments)
 */
...
*Note: ICs (BDRs/SDRs) are not decision-makers. At Mid-Market and Enterprise, they may serve as internal champions who can refer you upward, but should not be primary targets.*
